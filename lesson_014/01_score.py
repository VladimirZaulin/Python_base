...
if __name__ == "__main__":
    """
    Формат вызова 'python3 <путь к файлу> --result <счёт для подсчета>'
    """
    parser = argparse.ArgumentParser(description="Calculate bowling score.")
    parser.add_argument("--result", required=True, help="Game result string")
